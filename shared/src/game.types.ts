...
import type { MonopolyGameState } from "./games/monopoly.types.ts";
...
export const zGameKey = z.union([z.literal("nim"), z.literal("guess"), z.literal("monopoly")]);
...
export type TaggedGameView =
  ...
  | { type: "monopoly"; view: MonopolyGameState };
